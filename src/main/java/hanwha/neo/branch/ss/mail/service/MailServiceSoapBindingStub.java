...
public class MailServiceSoapBindingStub extends org.apache.axis.client.Stub implements hanwha.neo.branch.ss.mail.service.MailService {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnClass(hanwha.neo.branch.ss.mail.vo.WsMailStatus[].class);
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("sendMISSchedule");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://service.mail.ss.branch.neo.hanwha", "mailBody"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://service.mail.ss.branch.neo.hanwha", "scheduleInfo"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://vo.mail.ss.branch.neo.hanwha", "WsScheduleInfo"), hanwha.neo.branch.ss.mail.vo.WsScheduleInfo.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        oper.setReturnClass(java.lang.String.class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://service.mail.ss.branch.neo.hanwha", "sendMISMailReturn"));
    ...
    public MailServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cls = hanwha.neo.branch.ss.common.vo.WsAttachFile.class;
            ...
            cachedSerQNames.add(qName);
            cls = hanwha.neo.branch.ss.mail.vo.WsMailInfo.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = hanwha.neo.branch.ss.mail.vo.WsMailStatus.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = hanwha.neo.branch.ss.mail.vo.WsRecipient.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = hanwha.neo.branch.ss.mail.vo.WsResource.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://vo.mail.ss.branch.neo.hanwha", "WsScheduleInfo");
            cachedSerQNames.add(qName);
            cls = hanwha.neo.branch.ss.mail.vo.WsScheduleInfo.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {mailKey});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (hanwha.neo.branch.ss.mail.vo.WsMailStatus[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (hanwha.neo.branch.ss.mail.vo.WsMailStatus[]) org.apache.axis.utils.JavaUtils.convert(_resp, hanwha.neo.branch.ss.mail.vo.WsMailStatus[].class);
            }
        }
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {mailBody, mailInfo, receivers, attachFile});
  ...
  throw axisFaultException;
    ...
    public java.lang.String sendMISSchedule(java.lang.String mailBody, hanwha.neo.branch.ss.mail.vo.WsScheduleInfo scheduleInfo) throws java.rmi.RemoteException, hanwha.neo.branch.ss.common.vo.WsException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://service.mail.ss.branch.neo.hanwha", "sendMISSchedule"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {mailBody, scheduleInfo});
